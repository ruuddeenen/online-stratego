                ...
                buttons.push(
                    <div className='col-sm' key={i}>
                        <Button
                            ...
                            title={name}
                            disabled={!this.state.preperationMode}
                            onClick={e => this.selectPawn(e.target.title)}>
                            {this.state.preperationMode && this.state.pawnsLeftToPlace[rank]}
                            {!this.state.preperationMode && this.state.defeatedPawnList && (this.state.pawnInfo[rank].max - this.getDefeatedPawnsByRank(rank))}
